setTimeout(function () {
  ...
  function startScan() {
    ...
    setTimeout(function () {
      ...
      setTimeout(function () {
          document.getElementById("info").innerHTML = "menace détectée. <br> Dernière numérisation: " +  date_time + "<br> 11 nous avons trouvé la menace de cet incident.. <br> L'analyse a duré 0 minutes et 6 secondes. <br> 3821 fichiers numérisés. "
      }, 1000);
      setTimeout(function () {
          document.getElementById("bar").style.display = "none";
      }, 1000);
      setTimeout(function () {
          document.getElementById("re").innerHTML = "Analyse Rapide";
      }, 1000);
      setTimeout(function () {
